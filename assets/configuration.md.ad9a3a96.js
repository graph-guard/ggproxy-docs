import{_ as s,o as a,c as n,a as e}from"./app.12aff8b1.js";const A=JSON.parse('{"title":"Configuration","description":"","frontmatter":{},"headers":[{"level":2,"title":"Proxy & API","slug":"proxy-api"},{"level":2,"title":"Services","slug":"services"},{"level":2,"title":"Whitelist","slug":"whitelist"},{"level":2,"title":"Environment Variables","slug":"environment-variables"}],"relativePath":"configuration.md"}'),l={name:"configuration.md"},o=e(`<h1 id="configuration" tabindex="-1">Configuration <a class="header-anchor" href="#configuration" aria-hidden="true">#</a></h1><p>GraphGuard Proxy expects a specific configuration file structure. By default, the configuration directory is located under <code>/etc/ggproxy</code> but you can manually change it using <code>ggproxy serve -config &lt;path&gt;</code>.</p><h2 id="proxy-api" tabindex="-1">Proxy &amp; API <a class="header-anchor" href="#proxy-api" aria-hidden="true">#</a></h2><p>The configuration directory must contain the main configuration file <code>config.yaml</code> defining proxy and API server configurations:</p><div class="language-yaml"><button class="copy"></button><span class="lang">yaml</span><pre><code><span class="line"><span style="color:#676E95;"># /etc/ggproxy/config.yaml</span></span>
<span class="line"></span>
<span class="line"><span style="color:#F07178;">proxy</span><span style="color:#89DDFF;">:</span></span>
<span class="line"><span style="color:#89DDFF;">  </span><span style="color:#676E95;"># Address and port of the proxy server.</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    </span><span style="color:#F07178;">cert-file</span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">proxy.cert</span></span>
<span class="line"><span style="color:#89DDFF;">    </span><span style="color:#676E95;"># Private key file path.</span></span>
<span class="line"><span style="color:#A6ACCD;">    </span><span style="color:#F07178;">key-file</span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">proxy.key</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    }</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="environment-variables" tabindex="-1">Environment Variables <a class="header-anchor" href="#environment-variables" aria-hidden="true">#</a></h2><p><code>GGPROXY_LICENSE</code> is used to provide the license token.</p><p>If both <code>GGPROXY_API_USERNAME</code> and <code>GGPROXY_API_PASSWORD</code> are set then those are used for basic auth on the API, otherwise basic auth on the API will be disabled.</p>`,18),p=[o];function t(r,c,i,y,d,h){return a(),n("div",null,p)}const u=s(l,[["render",t]]);export{A as __pageData,u as default};
