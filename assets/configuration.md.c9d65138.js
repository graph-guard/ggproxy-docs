import{_ as s,o as n,c as a,a as e}from"./app.44a09230.js";const C=JSON.parse('{"title":"Configuration","description":"","frontmatter":{},"headers":[{"level":2,"title":"Ingress & API","slug":"ingress-api"},{"level":2,"title":"Services","slug":"services"},{"level":2,"title":"Whitelist","slug":"whitelist"}],"relativePath":"configuration.md"}'),l={name:"configuration.md"},p=e(`<h1 id="configuration" tabindex="-1">Configuration <a class="header-anchor" href="#configuration" aria-hidden="true">#</a></h1><p>GraphGuard Proxy expects a specific configuration file structure. By default, the configuration directory is located under <code>/etc/ggproxy</code> but you can manually change it using <code>ggproxy server -c &lt;path&gt;</code>.</p><h2 id="ingress-api" tabindex="-1">Ingress &amp; API <a class="header-anchor" href="#ingress-api" aria-hidden="true">#</a></h2><p>The configuration directory must contain the main configuration file <code>config.yaml</code> defining ingress and API server configurations:</p><div class="language-yaml"><button class="copy"></button><span class="lang">yaml</span><pre><code><span class="line"><span style="color:#676E95;"># /etc/ggproxy/config.yaml</span></span>
